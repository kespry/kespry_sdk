...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FirmatekKnownSurfacesApi.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/api/known-surfaces
     */
    this.basePath = 'https://localhost/api/known-surfaces'.replace(/\/+$/, '');
