...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    if (!root.FirmatekProductsApi) {
      root.FirmatekProductsApi = {};
    }
    root.FirmatekProductsApi.ProductsApi = factory(root.FirmatekProductsApi.ApiClient, root.FirmatekProductsApi.Error, root.FirmatekProductsApi.Product);
  }
  ...
  var exports = function(apiClient) {
    ...
    this.getProductDetail = function(productId, siteId, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/sites/{site_id}/products/{product_id}', 'GET',
